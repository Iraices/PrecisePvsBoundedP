...
#' @param percentile_ale                a value that indicates if the assessment is done an average child  by 'Average' or on a high consumer child by 95. Default is \code{NULL}
